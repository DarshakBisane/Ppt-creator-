...
ARCHETYPE_MAPPINGS: dict[VisualType, ArchetypeDescriptor] = {
    ...
    VisualType.ANATOMY: ArchetypeDescriptor(
        visual_type=VisualType.ANATOMY,
        preferred_archetype="anatomy",
        fallback_archetype="architecture",
        fallback_visual_type=VisualType.ARCHITECTURE,
        min_items=3,
        max_items=6,
        description="Central core object with labeled branching callout components",
    ),
    VisualType.LIFECYCLE: ArchetypeDescriptor(
        visual_type=VisualType.LIFECYCLE,
        preferred_archetype="lifecycle",
        fallback_archetype="process_flow",
        fallback_visual_type=VisualType.PROCESS_FLOW,
        min_items=3,
        max_items=6,
        description="End-to-end lifecycle progression with sequential step nodes and connectors",
    ),
    VisualType.DECISION_FLOW: ArchetypeDescriptor(
        visual_type=VisualType.DECISION_FLOW,
        preferred_archetype="decision_flow",
        fallback_archetype="flowchart",
        fallback_visual_type=VisualType.FLOWCHART,
        min_items=3,
        max_items=6,
        description="Step-by-step verification pipeline with checkpoints and verdict node",
    ),
    VisualType.LAYERED_STACK: ArchetypeDescriptor(
        visual_type=VisualType.LAYERED_STACK,
        preferred_archetype="layered_stack",
        fallback_archetype="architecture",
        fallback_visual_type=VisualType.ARCHITECTURE,
        min_items=3,
        max_items=5,
        description="Stacked hierarchical architecture layers with layer badges",
    ),
